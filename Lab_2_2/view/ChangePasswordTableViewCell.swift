...
fileprivate struct Password {
    static let passwordLabelText = "Изменить пароль"
...
class ChangePasswordTableViewCell: UITableViewCell {
    ...
    let titleLabel : UILabel = {
        let titleLabel = UILabel()
        titleLabel.text = Password.passwordLabelText
        titleLabel.font = Password.passwordLabelFont
        titleLabel.textColor = Password.passwordTextColor
        return titleLabel
    }()
    let border : UIView = {
        let border = UIView()
